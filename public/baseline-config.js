...
prompt: "How would you rate your current cardiovascular fitness?",
answerType: "ranged_choice",
options: [
...
{ label: "I know I should but it is inconsistent", score: 6 },
...
pillar: "Order",
subpillar: "Physical Order",
prompt: "How many unresolved physical problems exist in your home right now?",
answerType: "fixed_choice",
options: [
...
pillar: "Order",
subpillar: "Physical Order",
prompt: "If you own a vehicle, what is its current state?",
answerType: "ranged_choice",
options: [
...
pillar: "Order",
subpillar: "System Order",
prompt: "What is your average daily screen time on your phone?",
answerType: "fixed_choice",
options: [
...
pillar: "Order",
subpillar: "Physical Order",
prompt: "How many recurring friction points disrupt your daily flow?",
answerType: "fixed_choice",
options: [
...
pillar: "Order",
subpillar: "System Order",
prompt: "How consistently do you keep promises you make to yourself?",
answerType: "ranged_choice",
options: [
{ label: "Very consistently - my word to myself means something", score: 10 },
{ label: "Usually - I follow through more than I do not", score: 8 },
...
pillar: "Responsibility",
subpillar: "Duties",
prompt: "How clearly do you know your current financial position?",
answerType: "ranged_choice",
options: [
...
pillar: "Responsibility",
subpillar: "Duties",
prompt: "How on top of your maintenance responsibilities are you?",
answerType: "ranged_choice",
options: [
{ label: "On top of everything - nothing pending", score: 10 },
{ label: "Mostly current - a few small items", score: 8 },
{ label: "Some backlog - I will get to it eventually", score: 6 },
...
{ label: "Not dependable - it has caused real damage", score: 2 }
]
},
{
...
pillar: "Responsibility",
subpillar: "People",
prompt: "How intentional are you about investing in your key relationships?",
answerType: "ranged_choice",
options: [
{ label: "Very intentional - I show up consistently", score: 10 },
{ label: "Mostly intentional - I make real effort", score: 8 },
{ label: "Passive - I am present but not proactive", score: 6 },
...
pillar: "Responsibility",
subpillar: "People",
prompt: "When you say you will do something for someone, how often do you actually do it?",
answerType: "ranged_choice",
options: [
...
{ label: "Rarely - I say yes and do not follow through", score: 4 },
...
pillar: "Responsibility",
subpillar: "Duties",
prompt: "How many important tasks or obligations are you currently avoiding?",
answerType: "fixed_choice",
options: [
...
{ label: "Some gaps - I know where I am drifting", score: 6 },
...
pillar: "Responsibility",
subpillar: "Duties",
prompt: "How many open loops do you carry right now?",
answerType: "fixed_choice",
options: [
...
{ label: "I have ideas but have not chosen one", score: 6 },
...
pillar: "Mastery",
subpillar: "Practice",
prompt: "How intentional is your practice in your chosen pursuit?",
answerType: "ranged_choice",
options: [
{ label: "Highly deliberate - I know what I am working on each session", score: 10 },
{ label: "Mostly deliberate - clear direction most of the time", score: 8 },
{ label: "Somewhat - some sessions have purpose, some do not", score: 6 },
...
pillar: "Mastery",
subpillar: "Practice",
prompt: "Are you producing real output from your pursuit?",
answerType: "ranged_choice",
options: [
...
pillar: "Mastery",
subpillar: "Practice",
prompt: "What is your longest recent unbroken streak of deliberate practice?",
answerType: "fixed_choice",
options: [
...
{ label: "I cannot stay focused in practice", score: 2 }
]
},
{
...
{ label: "Minimal - I feel like I am improving but have no proof", score: 4 },
...
answerType: "ranged_choice",
options: [
{ label: "Completely - this is central to who I am becoming", score: 10 },
{ label: "Strongly - it matters a great deal", score: 8 },
{ label: "Reasonably - it is meaningful but not core", score: 6 },
{ label: "Loosely - it is something I do, not who I am", score: 4 },
...
pillar: "Mastery",
subpillar: "Pursuit",
prompt: "How committed are you to your pursuit long-term?",
answerType: "ranged_choice",
options: [
{ label: "Fully committed - this is a non-negotiable path", score: 10 },
{ label: "Strongly committed - I will not abandon it easily", score: 8 },
{ label: "Committed but with doubts", score: 6 },
{ label: "Wavering - I have considered quitting", score: 4 },
{ label: "I quit pursuits when they get hard", score: 2 }
]
},
{
...
{ label: "Vague - I practice but cannot pinpoint gaps", score: 4 },
...
pillar: "Mastery",
subpillar: "Pursuit",
prompt: "Does your environment support your practice?",
answerType: "ranged_choice",
options: [
{ label: "Yes - my environment makes it easy to start", score: 10 },
