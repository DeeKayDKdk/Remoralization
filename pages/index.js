    ...
    return (
      <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6">
        ...
        <div className="flex gap-4">
          <button
            className="bg-yellow-500 text-black font-semibold px-6 py-3 rounded-2xl hover:opacity-90"
            onClick={() => setView("how")}
          ...
          <button
            className="bg-white text-black font-semibold px-6 py-3 rounded-2xl border border-gray-200 hover:opacity-90"
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 p-8">
      ...
      <p className="text-center max-w-2xl mx-auto mb-1">
        Every two weeks you report against six pillars. A real human reads, replies, and holds you to your own standards.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        {pillars.map((pillar, i) => (
          <div key={pillar.title} className="bg-white shadow-lg rounded-2xl p-6 space-y-3">
            ...
            <textarea
              className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm min-h-24"
      ...
      <div className="flex flex-col items-center mt-8 gap-3">
        <div className="flex gap-3">
          <button
            ...
            className="bg-yellow-500 text-black px-6 py-3 rounded-2xl font-semibold hover:opacity-90 disabled:opacity-60"
          ...
          <button
            ...
            className="bg-white text-gray-900 border border-gray-300 px-6 py-3 rounded-2xl font-semibold hover:opacity-90"
